 ...
 *
 * Generated from protobuf message <code>validate.FloatRules</code>
 */
class FloatRules extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional float const = 1 [json_name = "const"];</code>
     */
     ...
     * exclusive
     *
     * Generated from protobuf field <code>optional float lt = 2 [json_name = "lt"];</code>
     */
    protected $lt = null;
    /**
     ...
     *
     * Generated from protobuf field <code>optional float lte = 3 [json_name = "lte"];</code>
     */
    protected $lte = null;
    /**
     ...
     * range is reversed.
     *
     * Generated from protobuf field <code>optional float gt = 4 [json_name = "gt"];</code>
     */
    protected $gt = null;
    /**
     ...
     *
     * Generated from protobuf field <code>optional float gte = 5 [json_name = "gte"];</code>
     */
    protected $gte = null;
    /**
     ...
     * values
     *
     * Generated from protobuf field <code>repeated float in = 6 [json_name = "in"];</code>
     */
    private $in;
    /**
     ...
     * values
     *
     * Generated from protobuf field <code>repeated float not_in = 7 [json_name = "notIn"];</code>
     */
    private $not_in;
    /**
